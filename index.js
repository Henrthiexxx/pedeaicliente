...
<body>
    <div class="offline-banner" id="offlineBanner">Você está offline</div>
    ...
    <div id="authPage" class="auth-container">
        ...
        <form id="registerForm" class="auth-form" onsubmit="handleRegister(event)">
            ...
            <div class="input-group">
                <label>Senha</label>
                <input type="password" class="input" id="registerPassword" placeholder="Mínimo 6 caracteres" required minlength="6">
            </div>
    ...
    <div id="mainApp" style="display: none;">
        ...
        <div id="homePage" class="page active">
            ...
            <div id="storeSelection">
                ...
                <p style="color: var(--text-muted); margin-bottom: 24px; font-size: 0.85rem;">Selecione onde você quer pedir</p>
        ...
        <div id="profilePage" class="page">
            ...
            <div class="profile-menu">
                <div class="profile-menu-item" onclick="showPage('addresses')">
                    ...
                    <div class="profile-menu-text">Meus endereços</div>
                    <div class="profile-menu-arrow">›</div>
                </div>
                <div class="profile-menu-item" onclick="showPage('orders')">
                    <div class="profile-menu-icon">≡</div>
                    <div class="profile-menu-text">Histórico de pedidos</div>
                    <div class="profile-menu-arrow">›</div>
                </div>
        ...
        <div id="addressesPage" class="page">
            <div style="display: flex; align-items: center; gap: 12px; margin-bottom: 24px;">
                <span style="font-size: 1.3rem; cursor: pointer;" onclick="showPage('profile')">←</span>
                <h2 style="font-weight: 400; letter-spacing: 1px;">Meus Endereços</h2>
            </div>
    ...
    <div class="modal" id="productModal">
        <div class="modal-content">
            <div class="product-detail-img" id="modalProductImg">◎</div>
            ...
            <div class="modal-body">
                ...
                <div class="delivery-mode-selector" style="display:flex;gap:8px;margin-bottom:24px;">
                    ...
                    <div class="mode-option" id="modePickup" onclick="setDeliveryMode('pickup')">
                        <span>🏪</span> Retirar na Loja
                    </div>
                </div>

                <div id="addressSection">
                    <h3 style="margin-bottom: 12px; font-weight: 400; font-size: 0.9rem; text-transform: uppercase; letter-spacing: 1px;">Endereço de entrega</h3>
                ...
                <div class="coupon-box">
                    <input type="text" class="input" id="couponInput" placeholder="Digite o código">
                ...
                <div class="payment-options" id="paymentOptions">
                    <label class="payment-option selected">
                        ...
                        <span class="payment-info"><span class="payment-name">PIX</span><span class="payment-desc">Pagamento instantâneo</span></span>
                    </label>
                    <label class="payment-option">
                        <input type="radio" name="payment" value="credit" onchange="selectPayment(this)">
                        <span class="payment-icon">💳</span>
                        <span class="payment-info"><span class="payment-name">Crédito</span><span class="payment-desc">Cartão de crédito</span></span>
                    </label>
                    <label class="payment-option">
                        <input type="radio" name="payment" value="debit" onchange="selectPayment(this)">
                        <span class="payment-icon">💳</span>
                        <span class="payment-info"><span class="payment-name">Débito</span><span class="payment-desc">Cartão de débito</span></span>
                    </label>
                    <label class="payment-option">
                    ...
                    <label class="payment-option">
                        ...
                        <span class="payment-info"><span class="payment-name">Alimentação</span><span class="payment-desc">Vale alimentação/refeição</span></span>
                    </label>
                </div>
            ...
            <div class="modal-body">
                <form onsubmit="saveAddress(event)">
                    ...
                    <div class="input-group">
                        ...
                        <input type="text" class="input" id="addressReference" placeholder="Próximo a...">
                    </div>
                    ...
                    <div class="location-box" id="addressLocationBox">
                        ...
                        <div style="display:flex;gap:8px;margin-top:12px;">
                            <button type="button" class="btn btn-secondary btn-sm" onclick="captureAddressLocation()" style="flex:1;">GPS automático</button>
